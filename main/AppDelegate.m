...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:@"fg-patch-8@ltg.evl.uic.edu" forKey:kXMPPmyJID];
    [[NSUserDefaults standardUserDefaults] setObject:@"fg-patch-8" forKey:kXMPPmyPassword];
